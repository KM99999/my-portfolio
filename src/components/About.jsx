  ...
  return (
    <>
      ...
      <div className="flex items-center min-[1000px]:flex-row flex-col-reverse">
        ...
        >
          Hello! I'm keisukeHashimoto, a Japan-based Full-Stack Developer
          ...
          project lifecycle from setup to deployment.  Feel free to
          explore my projects and get in touch at{" "}
          <a
            href="mailto:keisukeHashimotoDev@outlook.com"
          ...
          >
            keisukeHashimotoDev@outlook.com.
          </a>{" "}
